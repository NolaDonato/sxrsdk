...
namespace sxr
{
    ...
    Java_com_samsungxr_NativeVertexBuffer_ctor(JNIEnv *env, jclass obj, jstring descriptor,
                                               jint vertexCount)
    {
    ...
    Java_com_samsungxr_NativeVertexBuffer_getFloatVec(JNIEnv *env, jclass obj,
    ...
    Java_com_samsungxr_NativeVertexBuffer_getFloatArray(JNIEnv *env, jclass obj,
                                                        jlong jvbuf, jstring attribName)
    {
        VertexBuffer *vbuf = reinterpret_cast<VertexBuffer *>(jvbuf);
        const char *char_key = env->GetStringUTFChars(attribName, 0);
    ...
    Java_com_samsungxr_NativeVertexBuffer_getIntArray(JNIEnv *env, jclass obj,
                                                      jlong jvbuf, jstring attribName)
    {
        VertexBuffer *vbuf = reinterpret_cast<VertexBuffer *>(jvbuf);
        const char *char_key = env->GetStringUTFChars(attribName, 0);
    ...
    JNIEXPORT bool JNICALL
    Java_com_samsungxr_NativeVertexBuffer_setIntArray(JNIEnv *env, jclass obj,
                                                      jlong jvbuf, jstring attribName,
    ...
    JNIEXPORT bool JNICALL
    Java_com_samsungxr_NativeVertexBuffer_getIntVec(JNIEnv *env, jclass obj,
                                                    jlong jvbuf, jstring attribName,
                                                    jobject jintbuf,
    ...
    JNIEXPORT bool JNICALL
    Java_com_samsungxr_NativeVertexBuffer_setFloatArray(JNIEnv *env, jclass obj,
                                                        jlong jvbuf, jstring attribName,
    ...
    JNIEXPORT bool JNICALL
    Java_com_samsungxr_NativeVertexBuffer_setFloatVec(JNIEnv *env, jclass obj,
                                                      jlong jvbuf, jstring attribName,
                                                      jobject jfloatbuf, jint stride, jint ofs)
    {
        VertexBuffer *vbuf = reinterpret_cast<VertexBuffer *>(jvbuf);
    ...
    JNIEXPORT bool JNICALL
    Java_com_samsungxr_NativeVertexBuffer_setIntVec(JNIEnv *env, jclass obj,
                                                    jlong jvbuf, jstring attribName,
                                                    jobject jintbuf, jint stride, jint ofs)
    {
        ...
        if (bufptr)
        {
            ...
            if (capacity > 0)
            {
                rc = vbuf->setIntVec(char_key, bufptr + ofs, capacity - ofs, stride);
            }
        }
        env->ReleaseStringUTFChars(attribName, char_key);
        if (rc < 0)
    ...
    JNIEXPORT bool JNICALL
    Java_com_samsungxr_NativeVertexBuffer_isSet(JNIEnv *env, jclass obj,
                                                jlong jvbuf, jstring attribName)
    {
        VertexBuffer *vbuf = reinterpret_cast<VertexBuffer *>(jvbuf);
        const char *char_key = env->GetStringUTFChars(attribName, 0);
    ...
    Java_com_samsungxr_NativeVertexBuffer_getVertexCount(JNIEnv *env, jclass obj, jlong jvbuf)
    {
        VertexBuffer *vbuf = reinterpret_cast<VertexBuffer *>(jvbuf);
    ...
    JNIEXPORT int JNICALL
    Java_com_samsungxr_NativeVertexBuffer_getAttributeSize(JNIEnv *env, jclass obj,
                                                           jlong jvbuf, jstring attribName)
    {
        VertexBuffer *vbuf = reinterpret_cast<VertexBuffer *>(jvbuf);
        const char *char_key = env->GetStringUTFChars(attribName, 0);
    ...
    Java_com_samsungxr_NativeVertexBuffer_transform(JNIEnv *env, jclass obj,
    ...
    JNIEXPORT int JNICALL
    Java_com_samsungxr_NativeVertexBuffer_getBoundingVolume(JNIEnv *env, jclass obj,
    ...
    JNIEXPORT void JNICALL
    Java_com_samsungxr_NativeVertexBuffer_dump(JNIEnv *env, jclass obj,
