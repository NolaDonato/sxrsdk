...
namespace sxr
{
    ...
    public:
         ...
         * This function executes a Java task on the GL thread.
         */
        void bindShader(JNIEnv* env, const RenderState& state);
        ...
        int get_shader(int pass = 0) const
        { return render_pass_list_[pass]->get_shader(); }
