...
Renderer::~Renderer()
{
    if (mPostEffectSorter)
    {
        delete mPostEffectSorter;
        mPostEffectSorter = nullptr;
    }
    mShadowSorter = nullptr;
}
...
bool Renderer::renderPostEffectData(RenderState& rstate, RenderTexture* input_texture, RenderData* post_effect, int pass)
{
    ...
    {
        mPostEffectSorter = new RenderSorter("PostEffectSorter", 8);
    }
    ...
    RenderSorter::Renderable* added = mPostEffectSorter->add(rstate, r, *this);
